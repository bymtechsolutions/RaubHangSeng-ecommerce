  ...
  return (
    <section id="process" className="py-24 bg-white border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="relative bg-slate-50 border border-slate-200/85 hover:border-sky-300 hover:bg-white rounded-2xl p-6 transition-all duration-300 hover:shadow-md hover:-translate-y-1 group"
              >
                {/* Step numbering top-right */}
                <span className="absolute top-4 right-4 text-4xl font-black font-mono text-slate-200 group-hover:text-sky-100 transition-colors">
                  {step.stepNum}
                </span>

                {/* Step icon */}
                <div className="p-3 bg-white rounded-xl border border-slate-200 text-sky-500 w-12 h-12 flex items-center justify-center mb-6 group-hover:border-sky-300 group-hover:text-sky-600 transition-all shadow-xs">
        ...
        <div className="mt-12 bg-amber-50 border border-amber-200 rounded-2xl p-5 flex flex-col md:flex-row items-center justify-between gap-4">
